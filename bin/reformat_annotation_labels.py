...
This function was used to reformat the labels from a bounding box to a closed polygon.  

Unlikely to be needed in the future, but could be adapted for other issues with the labels.  
